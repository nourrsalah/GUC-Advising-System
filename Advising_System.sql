...
VALUES ('John Doe', 'john.doe@example.com', 'Office 101', 'advisor_password');
...
VALUES ('mark', 'Smith', 'student_password', 3.5, 'Engineering', 'mark.smith@example.com', 'Computer Science',1, 1, 200, 12, 1);

INSERT INTO Student (f_name, l_name, password, gpa, faculty, email, major, financial_status, semester, acquired_hours, assigned_hours, advisor_id)
VALUES ('Ali', 'labib', 'student_password', 3.5, 'Engineering', 'ali.smith@example.com', 'Computer Science',1, 1, 4, 12, 1);
...
VALUES ('Introduction to Programming', 'Computer Science', 1, 3, 1);
...
VALUES (1, 'Prof. Johnson', 'johnson@example.com', 'Engineering', 'Office 201');
...
VALUES (1, 1, 1, '202301', 'Normal', 'A');

-- Semester
INSERT INTO Semester (semester_code, start_date, end_date)
VALUES ('202301', '2023-01-01', '2023-05-31');
...
VALUES (1, 'Monday', '10:00 AM - 12:00 PM', 'Room 101', 1, 1);

-- Request

insert into Request (type,comment,credit_hours,course_id,student_id,advisor_id)
values ('ayhaga','whatever',6,1,1,1);



insert into Request (type,comment,credit_hours,course_id,student_id,advisor_id)
values ('ayhaga','whatever',5,1,1,2);


insert into Request (type,comment,credit_hours,course_id,student_id,advisor_id)
values ('yooh','whatever',5,1,1,1);
...
--exec Procedures_AdvisorViewAssignedStudents 1,'Computer Science'
...
Input: paymentID int
Output: Nothing                  C:\Users\alila\OneDrive\Desktop\milestone3db\Advising_System.sql
...
create proc [Procedures_getmetablecourses]
As
select * from Course

go
create proc [Procedures_getmetablegraduationplan]
as
select * from Graduation_Plan
...
Go
--exec Procedures_mycreated1 1

go
create proc Procedures_mycreated1
@AdvisorID int
As
Select Student.student_id, Student.f_name+' ' + Student.l_name as Student_name, Student.major
from Student 
