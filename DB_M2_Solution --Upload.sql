...
--USE master;
--SELECT * FROM sys.sysprocesses WHERE dbid = DB_ID('Advising_System');
--USE master;
--DROP DATABASE Advising_System;
...
--DECLARE @Password VARCHAR(20) = 'password123'
--DECLARE @Faculty VARCHAR(20) = 'Engineering'
--DECLARE @Email VARCHAR(50) = 'john.doe@example.com'
--DECLARE @Major VARCHAR(20) = 'Computer Science'
...
--INSERT INTO Student (password, financial_status)
--VALUES
--('password1', 1),  --1
--('password2', 1),  --2
--('nour', 1); --3
...
GO 
-- Replace with the actual Student ID and semester code
EXEC Procedures_ViewOptionalCourse @StudentID = 4, @current_semester_code = '2023_Spring';
...
( 'Smith', 'prof.smith@example.com', 'MET', 'Office A'),
( 'Johnson', 'prof.johnson@example.com', 'MET', 'Office B'),
( 'Brown', 'prof.brown@example.com', 'MET', 'Office C'),
( 'White', 'prof.white@example.com', 'MET', 'Office D'),
( 'Taylor', 'prof.taylor@example.com', 'Mechatronics', 'Office E'),
( 'Black', 'prof.black@example.com', 'Mechatronics', 'Office F'),
( 'Lee', 'prof.lee@example.com', 'Mechatronics', 'Office G'),
( 'Miller', 'prof.miller@example.com', 'Mechatronics', 'Office H'),
( 'Davis', 'prof.davis@example.com', 'IET', 'Office I'),
( 'Moore', 'prof.moore@example.com', 'IET', 'Office J');
